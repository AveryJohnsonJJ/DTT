...
from dtt.datasets import build_dataloader, build_dataset
from dtt.models import build_model
from dtt.utils import cache_checkpoint, mc_off, mc_on, test_port
import pickle
import numpy as np
def list_to_name(name):
    file=open(name,'rb')
...
def main():
    ...
    # joint=list_to_name('/root/pyskl/work_dirs/stgcn++/stgcn++_ntu60_xview_3dkp/j/best_pred.pkl')
    # bone=list_to_name('/root/pyskl/work_dirs/stgcn++/stgcn++_ntu60_xview_3dkp/b/best_pred.pkl')
    # jointM=list_to_name('/root/pyskl/work_dirs/stgcn++/stgcn++_ntu60_xview_3dkp/jm/best_pred.pkl')
    # boneM=list_to_name('/root/pyskl/work_dirs/stgcn++/stgcn++_ntu60_xview_3dkp/bm/best_pred.pkl')
    # outputs=[]
    # for j,b,jm,bm in zip(joint,bone,jointM,boneM):
    #     outputs.append(j*2/6+b*2/6+jm/6+bm/6)
    # for j,b in zip(joint,bone):
    #     outputs.append(j/2+b/2)
